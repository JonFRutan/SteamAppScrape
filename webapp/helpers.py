"""
This is the helpers.py file provided in our homeworks by Dr. Leonard, our professor.
We are re-purposing it for this project to provide a simple interface for running SQL queries in our web app.
All credit for this code goes to Dr. Leonard.
"""
